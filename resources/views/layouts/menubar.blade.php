                                ...
                                <ul class="cat_menu">
                                    ...
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            ...
                                            <li class="hassubs">
                                                <a href="#">{{$sub->subcategory_name}}<i class="fas fa-chevron-right"></i></a> @endforeach
                                                <ul>
    ...
    <div class="banner">
        ...
        <div class="container fill_height">
            <div class="row fill_height">
                <div class="banner_product_image"><img src="{{ $slider->image_one }}" alt="" style="height: 450px"></div>
