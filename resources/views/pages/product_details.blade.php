				...
				<div class="col-lg-5 order-3">
					<div class="product_description">
						...
						<div class="product_text">
							<p>
								{!! str_limit( $product->product_detail, $limit = 400 ) !!}
							</p>
						</div>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="form-group">
											<label for="exambleFormcontrolSelect1">Color</label>
											<select class="form-control input-lg" id="exambleFormcontrolSelect1" name="color">
									...
									<div class="col-lg-4">
										<div class="form-group">
											<label for="exambleFormcontrolSelect1">Size</label>
											<select class="form-control input-lg" id="exambleFormcontrolSelect1" name="size">
									...
									<div class="col-lg-4">
										<div class="form-group">
											<label for="exambleFormcontrolSelect1">Quantity</label>
											<input type="number" name="quantity" value="1" pattern="[1-9]" class="form-control" id="exambleFormcontrolSelect1">
										</div>
									</div>
			...
			<div class="row">
				<div class="col">
					<div class="viewed_title_container">
						<h3 class="viewed_title">Specifications</h3>
...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"><br><br>{!! $product->product_detail !!}</div>
  <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab"><br><br>{{ $product->video_link }}</div>
  <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab"><br><br>Hello World</div>
</div>
				</div>
			</div>
		</div>
