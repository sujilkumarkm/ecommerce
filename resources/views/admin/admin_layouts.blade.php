  ...
  <body>
    ...
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('add.blog.category_list')}}" class="sl-menu-link">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-bookmarks-outline tx-20"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('add.blog.post')}}" class="nav-link">Post List</a></li>
                    <li class="nav-item"><a href="{{ route('add.create.post' )}}" class="nav-link">Add Post</a></li>
        </ul>
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name">Sujil Kumar<span class="hidden-md-down"> KM</span></span>
     ...
     <script>
       $(document).on("click" ,"#delete", function(e){
        ...
        swal({
            ...
            text: "Hmmm ....Once deleted, this will be permanently removed !",
            icon: "warning",
            buttons: true,
            dangerMode: true
        })
